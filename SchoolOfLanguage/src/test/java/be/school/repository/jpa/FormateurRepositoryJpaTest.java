...
public class FormateurRepositoryJpaTest {
	...
	public void testFindByLoginAndPwd() {
		Formateur formateur = formateurRepository.findByLoginAndPwd("mutanda", "mutandapasswd");
		assertEquals("Mutanda", formateur.getNom());
		assertThat(formateur.getId(), is(Long.parseLong("1")));
		assertThat(formateur, allOf(hasProperty("id", is(Long.parseLong("1"))),
	...
	public void testUnSuccessLogin(){
		Formateur formateur = formateurRepository.findByLoginAndPwd("login","password");
